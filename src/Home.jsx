...
import { Movies } from "./components/BookMyShow/Movies/Movies";
import { NavBar } from "./components/BookMyShow/NavBar/NavBar";
import { TicketBooking } from "./components/BookMyShow/TicketBooking/TicketBooking";
import { apiUrl } from "./components/important/api";
import { Overlay } from "./components/OverLay/Overlay";
import apicalls from "./components/utills/apicalls";
      ...
      <UserContex.Provider value={price}>
        {loginStatus && stateUp.flag ? (
          ...
          <div className="mainContainer">
            ...
            />
      <Genres  apiData={apiData} newApicall={newApicall} />
      </div>
        )}
      </UserContex.Provider>
      {checkOverlay && (
